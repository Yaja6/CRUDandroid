...
1. Se agrega el documento **google-services.json** dentro de la carpeta **app** del proyecto android




## Interfaces o pantallas creadas: userInterface y messageInterface dentro de la carpeta **models**
